...
public class xhPacketMinePlus extends Module {
    ...
    public xhPacketMinePlus() {
        super(AddonTemplate.CATEGORY, "packet-mine-plus", "移植版发包挖掘 (Bypass Ground Optimized)");
    }
    ...
    public void onActivate() {
        ...
        if (mc.player != null) {
            serverSideSlot = mc.player.getInventory().selectedSlot;
        }
    }
    ...
    public void onTick(TickEvent.Pre event) {
        ...
        if (serverSideSlot == -1) serverSideSlot = mc.player.getInventory().selectedSlot;
