...
public class AutoDeoxidizer extends Module {
    ...
    public AutoDeoxidizer() {
        super(AddonTemplate.CATEGORY, "AutoDeoxidizer", "右键铜块或原木时自动切换斧头进行处理。除锈，去皮。");
    }
    ...
    private void onInteractBlock(InteractBlockEvent event) {
        ...
        int currentSlot = ((com.codigohasta.addon.mixin.InventoryAccessor) mc.player.getInventory()).getSelectedSlot();
