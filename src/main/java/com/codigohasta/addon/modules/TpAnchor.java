...
public class TpAnchor extends Module {
    ...
    public TpAnchor() {
        super(AddonTemplate.CATEGORY, "如来神掌·生锚打击", "射程范围内瞬间发动能力放置并引爆重生锚打击目标，娱乐功能，没有寻路能力");
    }
    ...
    private void performGodAttack(AttackPos info, int anchorSlot, int glowSlot, int shieldSlot) {
        Vec3d startPos = new net.minecraft.util.math.Vec3d(mc.player.getX(), mc.player.getY(), mc.player.getZ());
