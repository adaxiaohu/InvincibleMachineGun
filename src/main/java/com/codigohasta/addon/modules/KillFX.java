...
public class KillFX extends Module {
    ...
    public enum MagicParticle {
        ...
        ElderGuardian(ParticleTypes.ELDER_GUARDIAN, "远古守卫者"),
    ...
    public enum FireParticle {
        ...
        SmallFlame(ParticleTypes.SMALL_FLAME, "蜡烛火焰"),
        CopperFlame(ParticleTypes.COPPER_FIRE_FLAME, "铜火火焰"),
        Lava(ParticleTypes.LAVA, "岩浆崩裂"),
        LargeSmoke(ParticleTypes.LARGE_SMOKE, "浓烈黑烟"),
        Smoke(ParticleTypes.SMOKE, "普通烟雾"),
        WhiteSmoke(ParticleTypes.WHITE_SMOKE, "白色烟雾"),
        Campfire(ParticleTypes.CAMPFIRE_COSY_SMOKE, "营火轻烟"),
        CampfireSignal(ParticleTypes.CAMPFIRE_SIGNAL_SMOKE, "营火信号烟"),
    ...
    public enum NatureParticle {
        ...
        BubbleColumnUp(ParticleTypes.BUBBLE_COLUMN_UP, "气泡柱上升"),
        CurrentDown(ParticleTypes.CURRENT_DOWN, "气泡柱下降"),
        BubblePop(ParticleTypes.BUBBLE_POP, "气泡破裂"),
        Splash(ParticleTypes.SPLASH, "水花飞溅"),
        Fishing(ParticleTypes.FISHING, "钓鱼水纹"),
        Dolphin(ParticleTypes.DOLPHIN, "海豚游动"),
        Underwater(ParticleTypes.UNDERWATER, "水下气泡"),
        Note(ParticleTypes.NOTE, "音符"),
        Cherry(ParticleTypes.CHERRY_LEAVES, "樱花瓣"),
        PaleOakLeaves(ParticleTypes.PALE_OAK_LEAVES, "苍白橡树叶"),
        Firefly(ParticleTypes.FIREFLY, "萤火虫"),
    ...
    public enum CombatSound {
        ...
        MaceSmashHeavy("item.mace.smash_ground_heavy", "重锤重击(1.21)"),
        WindCharge("entity.wind_charge.wind_burst", "风弹爆裂"),
        CrossbowHit("item.crossbow.hit", "弩箭命中"),
        TridentHit("item.trident.hit", "三叉戟命中"),
        FireworkBlast("entity.firework_rocket.blast", "烟花爆炸"),
        AtkStrong("entity.player.attack.strong", "重击命中"),
        AtkSweep("entity.player.attack.sweep", "横扫命中");
    ...
    public enum MagicSound {
        ...
        Resonate("block.amethyst_block.resonate", "紫水晶共振"),
        EnderEye("entity.ender_eye.death", "末影之眼破碎"),
        ExpOrb("entity.experience_orb.pickup", "经验拾取"),
        EvokerCast("entity.evoker.cast_spell", "唤魔者施法"),
        ConduitAtk("block.conduit.attack_target", "潮涌核心攻击"),
        DragonFireball("entity.dragon_fireball.explode", "龙焰弹爆炸");
    ...
    public enum CreatureSound {
        ...
        AllayItem("entity.allay.item_given", "悦灵给予"),
        BreezeShoot("entity.breeze.shoot", "旋风人射击"),
        BreezeIdle("entity.breeze.idle_air", "旋风人飞行"),
        CreakingAttack("entity.creaking.attack", "嘎枝攻击"),
        CreakingDeath("entity.creaking.death", "嘎枝死亡"),
        CreakingSpawn("entity.creaking.spawn", "嘎枝生成"),
        BeeSting("entity.bee.sting", "蜜蜂蛰刺"),
        RavagerRoar("entity.ravager.roar", "劫掠兽咆哮");
    ...
    public enum FunSound {
        ...
        VillagerCelebrate("entity.villager.celebrate", "村民庆祝"),
        VillagerTrade("entity.villager.trade", "村民交易"),
        BellResonate("block.bell.resonate", "钟声共振"),
        NoteBit("block.note_block.bit", "电子乐"),
        NoteBanjo("block.note_block.banjo", "班卓琴");
